...
export interface paths {
    ...
    "/v1/turn": {
        ...
        get?: never;
        put?: never;
        /** Process a turn from an event (uses built-in appraisal) */
        post: {
            parameters: {
                query?: never;
                header?: never;
...
export interface components {
    schemas: {
        ...
        CreatePersonaRequest: {
            ...
            config?: {
                ...
                calibration?: {
                     ...
                     * @example 0.125
                     */
                    budget_recovery_per_hour?: number;
                    /**
        ...
        StateResponse: {
            ...
            prev_mask_integrity: number | null;
        ...
        UnhealthyPatternResult: {
            ...
            /** @enum {string} */
            pattern_type?: "excessive_dependency" | "avoidant_withdrawal" | "anxious_avoidant_oscillation";
            severity: number;
            recommended_action?: {
